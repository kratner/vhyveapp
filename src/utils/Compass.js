    ...
    i = (window.Compass = {
        ...
        return (
          i.init(function(n) {
            if (n === "phonegap")
              ...
              i._win.addEventListener("deviceorientation", r),
                (i._watchers[t] = r);
            } else if (n == "orientationAndGPS") {
              var s,
                r = function(t) {
                  (s = -t.alpha + i._gpsDiff),
      ...
      unwatch: function(e) {
        return (
          i.init(function(t) {
            t == "phonegap"
              ? i._nav.compass.clearWatch(i._watchers[e])
              : (t == "webkitOrientation" || t == "orientationAndGPS") &&
                i._win.removeEventListener("deviceorientation", i._watchers[e]),
              delete i._watchers[e];
          }),
          i
        );
      },
      ...
      noSupport: function(e) {
        return (
          i.method === !1 ? e() : t(i.method) || i._callbacks.noSupport.push(e),
          i
        );
      },
      init: function(e) {
        ...
        return (
          ...
          i._nav.compass
            ? i._start("phonegap")
            : i._win.DeviceOrientationEvent
            ? ((i._checking = 0),
              i._win.addEventListener("deviceorientation", i._checkEvent),
              setTimeout(function() {
      ...
      _start: function(e) {
        (i.method = e),
          ...
          (i._callbacks.init = []),
          e === !1 && n("noSupport", []),
          (i._callbacks.noSupport = []);
      },
      _checking: !1,
      _checkEvent: function(e) {
        i._checking += 1;
        var n = !1;
        t(e.webkitCompassHeading)
          ? i._start("webkitOrientation")
          : t(e.alpha) && i._nav.geolocation
          ? i._gpsHack()
          : i._checking > 1
          ? i._start(!1)
          : (n = !0),
          n ||
            ((i._checking = !1),
            i._win.removeEventListener("deviceorientation", i._checkEvent));
      },
      _gpsHack: function() {
        var e = !0,
          s = [],
            ...
            e && ((e = !1), n("needMove")),
              f.speed > 1
                ? (o.push(f.heading),
                  o.length >= 5 &&
                    s.length >= 5 &&
                    (i._win.removeEventListener("deviceorientation", u),
                    i._nav.geolocation.clearWatch(l),
                    (i._gpsDiff = r(o) + r(s)),
                    i._start("orientationAndGPS")))
                : (o = []);
          },
          f = function() {
